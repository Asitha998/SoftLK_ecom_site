...
<head>
    ...
    <title>Selling History | Admins | SoftLk</title>
...
<body class="main-body">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-1 bg-light bg-opacity-50 py-2">
                <label class="form-label text-dark Scurser" onclick="window.location = 'adminPanel.php'"><i class="bi bi-arrow-left-circle fs-3"></i></label>
            </div>
            ...
            <div class="col-12 bg-light mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-1 mt-3 mb-3 d-grid">
                        <button class="btn btn-primary fs5 fw-bold" onclick="findSellings();">Find</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 mt-2" id="viewArea">
                ...
                $query = "SELECT * FROM `invoice` INNER JOIN `invoice_item` ON `invoice`.`id` = `invoice_item`.`invoice_id`";
                $pageno;
                ...
                ?>
                    <div class="row" id="allSellings">
                        ...
                        <div class="col-3 bg-secondary text-end">
                            <?php
                            $buyer_rs =  Database::search("SELECT * FROM `user` WHERE `email`='" . $selected_data["user_email"] . "'");
                        ...
                        <div class="col-2 bg-body text-end">
                            <label class="form-label fs-5 fw-bold mt-1 mb-1">Rs. <?php echo $selected_data["total"]; ?> .00</label>
                        </div>
                        <div class="col-1 bg-secondary text-end">
