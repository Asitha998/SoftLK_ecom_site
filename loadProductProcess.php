...
if ($min == 0 && $max == 0) {
    ...
    if ($cid == 0) {
        ...
        $query .= " WHERE `category_id`='" . $cid . "' AND `price` BETWEEN '".$min."' AND '".$max."'";
    }
}
            ...
            <ul class="pagination pagination-lg justify-content-center">
                <li class="page-item">
                    <a class="page-link border-0 bg-black bg-opacity-50" <?php if ($pageno <= 1) {
                                                                            ...
                                                                            ?> onclick="loadProductsByCat(<?php echo ($pageno - 1) ?>,<?php echo ($cid) ?>,'<?php echo ($cname) ?>');" <?php
                                                                                                                                                                                    } ?> aria-label="Previous">
                ...
                ?>
                        <li class="page-item active">
                            <a class="page-link border-0 bg-black bg-opacity-50" onclick="loadProductsByCat(<?php echo ($x) ?>,<?php echo ($cid) ?>,'<?php echo ($cname) ?>');"><?php echo $x; ?></a>
                        </li>
                    <?php
                    } else {
                    ?>
