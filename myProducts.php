...
?>
    ...
    <head>
        ...
        <title>My Products | SoftLK</title>
    ...
    <body class="main-body min-vh-100">

        <div class="container-fluid">
            <div class="row">

                <!-- header -->
                <div class="col-12 bg-dark bg-opacity-75">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-4 mt-1 mb-1 text-center">
                                    ...
                                    ?>
                                        ...
                                        <img src="profile images/new_user.svg" width="90px" height="90px" class="rounded-circle">
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="row">
                                <div class="col-12 col-lg-8 mt-2 my-lg-4 ">
                                    <h1 class="offset-4 offset-lg-3 text-white fw-bold">My Software & Games</h1>
                                </div>
                                ...
                                <div class="col-12 col-lg-2 mx-2 mb-2 my-lg-4 mx-lg-0 d-grid">
                                    <button class="btn btn-info fw-bold" onclick="window.location='home.php'">Go to Home</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="row">
                        <!-- filter  -->
                        <div class="col-11 col-lg-2 mx-3 my-3 bg-light bg-opacity-25 rounded shadow">
                            <div class="row">
                                <div class="col-12 mt-3 fs-5">
                                    <div class="row">
                                        <div class="col-12">
                                            <label class="form-label fw-bold fs-3 text-white-50">Sort Product</label>
                                        </div>
                                        <div class="col-11">
                                            <div class="row">
                                                <div class="col-10">
                                                    <input type="text" placeholder="Search..." class="form-control bg-light border-0 bg-opacity-50" id="s">
                                                </div>
                                                <div class="col-1 p-1">
                                                    <label class="form-label"><i class="bi bi-search fs-5 text-white-50"></i></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label fw-bold text-white mt-2 mb-0">Added time</label>
                                        </div>
                                        <div class="col-12">
                                            <hr style="width: 80%;" class="text-white-50 mt-0"/>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="r1" id="n">
                                                <label class="form-check-label text-white-50" for="n">
                                                    Newest to oldest
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label text-white-50" for="o">
                                                    Oldest to newest
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-12 mt-3">
                                            <label class="form-label fw-bold text-white mb-0">By Quantity</label>
                                        </div>
                                        <div class="col-12">
                                            <hr style="width: 80%;" class="text-white-50 mt-0"/>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label text-white-50" for="h">
                                                    High to low
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label text-white-50" for="l">
                                                    Low to high
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-12 mt-3">
                                            <label class="form-label fw-bold text-white mb0">By Type</label>
                                        </div>
                                        <div class="col-12">
                                            <hr style="width: 80%;" class="text-white-50 mt-0"/>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label text-white-50" for="b">
                                                    Digital
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label text-white-50" for="u">
                                                    DVD
                                                </label>
                                            </div>
                                        </div>
                        ...
                        <!-- filter  -->
                        <!-- product -->
                        <div class="col-12 col-lg-9 mt-3 mb-3 rounded">
                            <div class="row" id="sort">
                                ...
                                <div class="offset-1 col-10 text-center">
                                    <div class="row justify-content-center">
                                        ...
                                        LIMIT " . $results_per_page . " OFFSET " . $page_result . "");
                                        ...
                                        ?>
                                            ...
                                            <!-- card -->
                                            <div class="card mb-3 mt-3 mx-1 col-12 col-lg-5  bg-light bg-opacity-50">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input Scurser" type="checkbox" role="switch" id="fd<?php echo $selected_data["id"] ?>" 
                                                                <?php if ($selected_data["status_id"] == 1) { ?>checked<?php } ?> onclick="changeStatus(<?php echo $selected_data['id'] ?>);">
