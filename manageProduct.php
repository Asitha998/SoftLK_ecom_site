...
<head>
    ...
    <title>Manage Products | Admins | SoftLK</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            ?>
                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2" onclick="viewProductModal('<?php echo $selected_data['id']; ?>');">
                            ...
                            if ($image_num == 0) {
                            ?>
                                <img src="resource/empty.svg" class="rounded" style="height: 40px;margin-left: 80px;">
                            <?php
                            } else {
                                $image_data = $image_rs->fetch_assoc();

                            ?>
                                <img src="<?php echo $image_data["code"]; ?>" class="rounded" style="height: 40px;margin-left: 80px;">
                            <?php
                            }
                            ?>
                        </div>
                ...
                <!-- modal 01 -->
                <div class="modal fade" tabindex="-1" id="viewProductModal<?php echo $selected_data["id"]; ?>">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body overflow-auto">
                                <div class="offset-4 col-4">
                                    ...
                                    if ($image_num == 0) {
                                    ?>
                                        <img src="resource/empty.svg" class="img-fluid rounded" style="height: 150px;">
                                    <?php
                                    } else {
                                    ?>
                                        <img src="<?php echo $image_data["code"]; ?>" class="img-fluid rounded" style="height: 150px;">
                                    <?php
                                    }
                                    ?>
                                </div>
            ...
            <div class="col-12 text-center bg-light bg-opacity-25">
                <h3 class="text-black-50 fw-bold">Manage Categories</h3>
            </div>

            <div class="col-12 mb-3 bg-light bg-opacity-50">
                <div class="row gap-2 justify-content-center">
                    ...
                    ?>
                        <div class="col-12 col-lg-3 border border-danger rounded py-2">
                            <div class="row">
                                <div class="col-8">
                                    <label class="form-label fw-bold fs-5"><?php echo $category_data["category_name"] ?></label>
                                </div>
                    ...
                    <div class="col-12 col-lg-3 border border-success rounded py-2" onclick="addNewCategory();">
                        <div class="row">
                            <div class="col-8">
            ...
            <!-- modal 02 verifyCategory();-->
             
            <!-- modal 03 -->
            <!-- <div class="modal fade" tabindex="-1" id="addCategoryVerificationModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title fw-bold text-success">Verification</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="col-12 mt-3 mb-3">
