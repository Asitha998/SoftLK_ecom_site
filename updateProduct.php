...
<head>
    ...
    <title>Update Product | SolfLK</title>
                    ...
                    <div class="col-12 col-lg-10 offset-lg-1">
                        <div class="row">
                            ...
                            <div class="col-12 text-center">
                                <h2 class="h2 text-primary fw-bold text-white">Update Product</h2>
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <select class="form-select  text-center bg-light bg-opacity-50 shadow border-0 border-bottom" id="type">
                                                    ...
                                                    $type_rs = Database::search("SELECT * FROM `type` WHERE `id` = '" . $product["type_id"] . "'");
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="offset-0 offset-lg-2 col-12 col-lg-8">
                                                <input type="text" placeholder="Add a title..." class="form-control bg-light bg-opacity-50 shadow border-0 border-bottom" value="<?php echo $product["title"]; ?>" id="t">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-4 border-end border-dark border-opacity-50">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <input type="number" class="form-control bg-light bg-opacity-50 shadow border-0 border-bottom" value="<?php echo $product["qty"] ?>" min="1" id="q">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="offset-0 offset-lg-2 col-12 col-lg-8">
                                                        <div class="input-group mb-2 mt-2">
                                                            ...
                                                            <input type="text" class="form-control bg-light bg-opacity-50 shadow border-0 border-bottom" id="cost" value="<?php echo $product["price"] ?>">
                                                    ...
                                                    <div class="col-12 col-lg-6 border-end border-dark border-opacity-50">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-8">
                                                                <div class="input-group mb-2 mt-2">
                                                                    <span class="input-group-text">Rs.</span>
                                                                    <input type="text" class="form-control bg-light bg-opacity-50 shadow border-0 border-bottom" value="<?php echo $product["delivery_fee_colombo"] ?>" id="dwc">
                                                                    <span class="input-group-text">.00</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-8">
                                                                <div class="input-group mb-2 mt-2">
                                                                    <span class="input-group-text">Rs.</span>
                                                                    <input type="text" class="form-control bg-light bg-opacity-50 shadow border-0 border-bottom" value="<?php echo $product["delivery_fee_other"] ?>" id="doc">
                                                                    <span class="input-group-text">.00</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <textarea cols="30" rows="5" class="form-control bg-light bg-opacity-50 border-0 shadow" id="desc"><?php echo $product["description"] ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="offset-lg-3 col-12 col-lg-6">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-4 bg-light border-0 bg-opacity-50 rounded shadow">
                                                                <img src="<?php echo $img[0]; ?>" class="img-fluid" style="height: 300px;" id="i0">
                                                            </div>
                                                            <div class="col-4 bg-light border-0 bg-opacity-50 rounded shadow">
                                                                <img src="<?php echo $img[1]; ?>" class="img-fluid" style="height: 300px;" id="i1">
                                                            </div>
                                                            <div class="col-4 bg-light border-0 bg-opacity-50 rounded shadow">
                                                                <img src="<?php echo $img[2]; ?>" class="img-fluid" style="height: 300px;" id="i2">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="offset-lg-3 col-12 col-lg-6 mt-3">
                                                        <input type="file" class="d-none" id="imageUploader" multiple />
                                                        <label for="imageUploader" class="ms-4 col-8 btn btn-outline-primary shadow"  onclick="changeProductImage();">Upload Images</label>
                                                        <label class="col-3 btn btn-secondary shadow"  onclick="saveProductImage();">Save Images</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="offset-lg-4 col-12 col-lg-4 d-grid mt-3 mb-3">
                                                <button class="btn btn-success shadow" onclick="updateProduct();">Update</button>
                                            </div>
